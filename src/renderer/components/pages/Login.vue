<template>
  <div class="login_container">
    <div id="login-container">
      <div class="top-container" :class="{'shadow': bottomContainerShown}">
        <div class="header-btns">
          <img src="~@/assets/close.png" class="close" @click="closeWindow">
        </div>
        <div class="main-container">
          ...
          <div class="login-form" v-if="loginStatus === -1">
            <div class="username form-item">
              <input type="text" :ref="refEle.username" v-model="loginForm.username" placeholder="输入账号"/>
            </div>
            <div class="password form-item">
              <input type="password" :ref="refEle.password" v-model="loginForm.password" placeholder="输入密码"/>
              <div class="login" :class="{'shown': (loginForm.username.trim() !== '' && loginForm.password.trim() !== '')}" @click="login">
                <img src="~@/assets/login.png" alt="登录">
              </div>
            </div>
          </div>
          <div class="login-form-sending" v-if="loginStatus === 0">
            <div class="info-username" v-text="loginForm.username"></div>
            <div class="login-cancel">
              <button type="button">取消</button>
            </div>
          </div>
          <div class="login-form-sending" v-if="loginStatus === 1">
            <div class="info-username" v-text="loginForm.username || 'ls'"></div>
            <div class="info-username">
              <img src="~@/assets/success.png">
            </div>
          </div>
        </div>
        <div class="bottom-btns" @click="toggleBottomContainer">
          <img class="show-bottom-container" :class="{'up': bottomContainerShown}" src="~@/assets/down.png">
        </div>
      </div>
      <div class="bottom-container" :class="{'shown': bottomContainerShown}">
        <div class="item">
          <div class="left">
    ...
    <audio :src="bgAudio.src" autoplay :ref="bgAudio.ref" id="bg-audio"></audio>
  </div>
</template>
<style>
  .fs14 {
  ...
  #login-container .top-container .main-container .login-form .password .login.shown {
    display: inline-flex;
  }
